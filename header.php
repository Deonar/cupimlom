...
<head>
  ...
  <?php wp_head(); ?>
  <?php get_template_part('inc/js_var'); ?>
  ...
  <header id="header" class="header <?php echo (is_front_page()) ? "header_white" : "" ?>">
    <div class="header__wrapp">
      ...
      <div class="header__logo">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo_white.svg" class="logo_white"
          alt="logo_white">
      </div>
      <?php
			else :
