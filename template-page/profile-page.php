    ...
    <div class="container-wrapper">
      <div class="profile-body tab-wrapper-js">
        ...
        <div class="profile-tabs__content">
                ...
                <div class="profile-info__block-row">
                  ...
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__radio-group d-flex">
                      <input class="main-form__radio-input" type="radio" id="form-phys-face" name="type-employment"
                        checked />
                  ...
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp done">
                      <input class="main-form__input" type="text" name="client-name" id="client-name"
                        placeholder="Алексеев Алексей Алексеевич" maxlength="50">
              ...
              <form class="profile-info__block-form profile-form edit-form-js">
                ...
                <div class="profile-info__block-row">
                  <div class="profile-form__row justify-content-between">
                    <span class="main-form__label">Фото паспорта <span class="main-form__label-desc">Загрузите фото
                        лицевой
                  ...
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp" style="max-width: 155px;">
                      <input class="main-form__input" type="text" name="client-nr-passport" id="client-nr-passport"
                        placeholder="44 22 331 234" maxlength="15">
                      <span class="main-form__label-error">Ошибка в номере</span>
                    </div>
                  </div>
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp" style="max-width: 155px;">
                      <input class="main-form__input" type="text" name="client-birthday" id="client-birthday"
                        placeholder="10.08.1985" maxlength="10">
                  ...
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp">
                      <input class="main-form__input" type="text" name="client-place-birthday"
                        id="client-place-birthday" placeholder="РФ, г. Челябинск" maxlength="50">
                  ...
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp" style="max-width: 155px;">
                      <input class="main-form__input" type="text" name="client-date-issue" id="client-date-issue"
                        placeholder="10.08.1985" maxlength="10">
                      <span class="main-form__label-error">Ошибка</span>
                    </div>
                  </div>
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp">
                      <input class="main-form__input" type="text" name="client-place-issue" id="client-place-issue"
                        placeholder="УФМС России по Челябинской области" maxlength="10">
                      <span class="main-form__label-error">Ошибка</span>
                    </div>
                  </div>
                </div>
              ...
              <form class="profile-info__block-form profile-form edit-form-js">
                ...
                <div class="profile-info__block-row">
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp" style="max-width: 155px;">
                      <input class="main-form__input" type="text" name="client-index-passport"
                        id="client-index-passport" placeholder="454 078" maxlength="20">
                      <span class="main-form__label-error">Ошибка в номере</span>
                    </div>
                  </div>
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp">
                      <input class="main-form__input" type="text" name="client-region" id="client-region"
                        placeholder="Уральский" maxlength="50">
                      <span class="main-form__label-error">Ошибка</span>
                    </div>
                  </div>
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp">
                      <input class="main-form__input" type="text" name="client-city" id="client-city"
                        placeholder="Челябинск" maxlength="50">
                      <span class="main-form__label-error">Ошибка</span>
                    </div>
                  </div>
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp">
                      <input class="main-form__input" type="text" name="client-street" id="client-street"
                        placeholder="пр-т. Ленина" maxlength="50">
                      <span class="main-form__label-error">Ошибка</span>
                    </div>
                  </div>
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp" style="max-width: 155px;">
                      <input class="main-form__input" type="text" name="client-house" id="client-house" placeholder="53"
                        maxlength="10">
                      <span class="main-form__label-error">Ошибка</span>
                    </div>
                  </div>
                  ...
                  <div class="profile-form__row">
                    ...
                    <div class="main-form__input-wrapp" style="max-width: 155px;">
                      <input class="main-form__input" type="text" name="client-" id="client-place-issue" placeholder="7"
                        maxlength="10">
                      <span class="main-form__label-error">Ошибка</span>
                    </div>
                  </div>
          ...
          <!-- TAB PROFILE END-->
          <!-- TAB dealings-->
          <div id="dealings-tab-content" class="dealings-tab-content dealings tab-content-js" data-tab="2"
            style="display: none">
            <div class="transactions-head">
              <div class="transactions-sort__daterange">
                <label class="daterange-input__label" for="daterange-input">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/icon-daterange-input.svg"
                    alt="" />
                </label>
          ...
          <!-- TAB dealings END-->
          <!-- TAB ANALITICS-->
          <div id="analitics-tab-content" class="analitics profile-tab__content tab-content-js" data-tab="3"
            style="display: none">
            Аналитика
          </div>
          <!-- TAB ANALITICS END-->
