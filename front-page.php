      ...
      <div class="grid-rectangle__col">
        <a href="#" class="grid-rectangle__item">
          ...
          <div class="grid-rectangle__icon">
            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 1H22C23.6569 1 25 2.34315 25 4V25M1.5 24.5L23.5 2.5" stroke="#333333" stroke-width="2"
                stroke-linecap="round"></path>
            </svg>
          </div>
        </a>
    ...
    <div class="calculator">
      ...
      <div class="calculator__wrap">
        ...
        <div class="select-metal mb-30">
          <div class="select-metal__img mr-20"
            style="background-image: url(https://sdaykat.ru/wp-content/uploads/front-page-bg.jpg);">
          </div>
          <div class="mt-auto">
      ...
      <div class="col-12 offset-sm-3 offset-md-0 col-sm-9 col-md-8">
        <div class="content-wrap">
          <p class="mb-30">
            ...
            важные задания по разработке дальнейших направлений развития. Идейные соображения высшего порядка, а также
            начало повседневной работы по формированию позиции представляет собой интересный эксперимент проверки форм
            развития. Равным образом реализация намеченных плановых заданий влечет за собой процесс внедрения и
